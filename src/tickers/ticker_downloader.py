...
class TickerDownloader:
    ...
    Methods:
        ...
        download_tickers_data(tickers: List[str], start: str, end: str) -> pd.DataFrame:
            Downloads ticker data for a list of tickers and a specified date range.
        download_tickers_sp500(x_years: int, force_reload: bool = False) -> pd.DataFrame:
    ...
    def download_tickers_data(self, tickers: List[str], x_years: int = None, start: str = None, end: str = None) -> pd.DataFrame:
        """Downloads ticker data for a list of tickers and a specified date range.
    ...
    def download_tickers_sp500(self, x_years: int, force_reload: bool = False) -> pd.DataFrame:
        ...
        df = self.download_tickers_data(sp500_tickers, start=start, end=end)
