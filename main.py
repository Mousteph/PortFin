...
def print_arguments_selected(args: argparse.Namespace):
    ...
    print(f"Optimizer selected: {args.optimizer} | Regularization parameter: {args.gamma} | Minimum weight of each asset: {args.weight}")
...
if __name__ == '__main__':
    ...
    optimizer_tickers = OptimizerEfficient(args.optimizer, args.gamma, args.weight)
